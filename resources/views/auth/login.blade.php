			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{ asset('public/admin/assets/img/logoperpusmtk4.png') }}" ></div>
							</div>
                            ...
                            {{csrf_field()}}
								...
								<button type="button" class="btn btn-danger btn-sm"><a href="{{ url()->previous() }}"><span>Kembali</span></a></button>
							</form>
						</div>
					</div>
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Aplikasi Perpustakaan Matematika</h1>
						</div>
					</div>
